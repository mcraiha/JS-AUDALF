...
// SerializeBoolArrayToAUDALFList()
Deno.test("Serialize bool array to AUDALF list", () => {
  // Arrange
  ...
  assertEquals(result.length, Number(byteSize), "Result payload should have correct amount lenght info");
  assertEquals(isDictionary, false, "Result should contain an array, not a dictionary");
  assertEquals(boolArray.length, Number(indexCount), "Result should contain certain number of items");
  assertEquals(indexCount, BigInt(entryDefinitionOffsets.length), "Result should have certain number of entry definitions");
...
Deno.test("Serialize byte-byte Map to AUDALF bytes", () => {
  ...
  assertEquals(byteByteMap.size, Number(indexCount), "Result should contain certain number of items");
  assertEquals(indexCount, BigInt(entryDefinitionOffsets.length), "Result should have certain number of entry definitions");
...
Deno.test("Serialize int-int Map to AUDALF bytes", () => {
  // Arrange
  ...
  assertEquals(result.length, Number(byteSize), "Result payload should have correct amount lenght info");
  assertEquals(isDictionary, true, "Result should contain a dictionary, not an array");
  assertEquals(intIntMap.size, Number(indexCount), "Result should contain certain number of items");
  assertEquals(indexCount, BigInt(entryDefinitionOffsets.length), "Result should have certain number of entry definitions");
